		...
		onSubmit: async (values) => {
			let newPost: Post = {
				...
				content: JSON.stringify(
					convertToRaw(
						values.postEditorState.getCurrentContent()
					)
				),
			};
			...
			history.push(
				`/categories/${newPost.categoryId}/posts/${newPost.id}`
			);
		},
	});
	...
	return (
		<>
			...
			>
				...
				<div
					id="newPostCategory"
					className="row flex-grow-0 mt-3"
				>
				...
				<div
					id="newPostContent"
					className="row no-gutters flex-grow-1 mt-3"
				>
					<div
